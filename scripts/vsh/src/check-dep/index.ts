...
import { getPackages } from '@react-admin/node-utils';
...
const DEFAULT_CONFIG = {
  ...
  ignoreMatches: [
    ...
    'vitest',
    'unbuild',
    '@react-admin/ts-config',
    '@react-admin/vite-config',
    '@react-admin/tailwindcss-config',
    '@types/*',
    '@react-admin-core/design',
  ],
  // 需要忽略的包
  ignorePackages: [
    '@react-admin/backend-mock',
    '@react-admin/commitlint-config',
    '@react-admin/eslint-config',
    '@react-admin/node-utils',
    '@react-admin/prettier-config',
    '@react-admin/stylelint-config',
    '@react-admin/tailwindcss-config',
    '@react-admin/ts-config',
    '@react-admin/vite-config',
    '@react-admin/vsh',
