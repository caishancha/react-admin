...
import type { NitroMockPluginOptions } from '../typing.ts';

import { colors, consola, getPackage } from '@react-admin/node-utils';
...
export const viteNitroMockPlugin = ({
  mockServerPackage = '@react-admin/backend-mock',
  port = 8080,
  verbose = true,
