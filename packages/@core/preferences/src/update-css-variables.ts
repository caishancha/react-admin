...
import { generatorColorVariables } from '@react-admin-core/shared/color';
import { updateCSSVariables as executeUpdateCSSVariables } from '@react-admin-core/shared/utils';
...
function updateMainColorVariables(preference: Preferences) {
  ...
  const colorMappings = {
    ...
    '--color-red-500': '--destructive',
    '--color-yellow-500': '--warning',
  };
